...
export function ProfileButton() {
  ...
  const modalContent = isOpen && mounted && typeof document !== 'undefined' ? (
    ...
    >
      <div
        className="w-full max-w-sm bg-[#151C24] border border-[#232B34] rounded-[24px] p-6 text-[#E7EBEF] shadow-2xl space-y-5 animate-in zoom-in-95 duration-200"
  ...
  return (
    <>
      ...
      {/* Modal renderizado a través de Portal en document.body para evitar que el sticky/backdrop-blur lo atrape */}
